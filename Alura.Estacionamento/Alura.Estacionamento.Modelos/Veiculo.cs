...
namespace Alura.Estacionamento.Modelos
{
    public class Veiculo : IEnumerable<object[]>
    {
        ...
        public string Proprietario
        {
            ...
            {
                if (value.Length < 3)
                    throw new System.FormatException("Nome do proprietário inválido");
        ...
        public void AlterarDados(Veiculo encontrado)
        {
            this.Proprietario = encontrado.Proprietario;
            this.Modelo = encontrado.Modelo;
            this.Largura = encontrado.Largura;
